是给大家介绍观察者模式(the Observer Pattern，译注：也有叫发布-订阅模式)的时候了。如果你关注本博有一段时间了，那你应该已经通过[这篇博客][whyplugin]的介绍，对我的jQuery插件[JZ Publish/Subscribe][plugin]有所了解了。接下来我们会讨论观察者模式的几种实现方式，所以你会知道哪一个是最适合你和你的应用程序的方式。
